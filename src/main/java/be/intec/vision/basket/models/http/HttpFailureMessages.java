package be.intec.vision.basket.models.http;
...
public enum HttpFailureMessages {
	...
	SESSION_IS_REQUIRED( "Session ID is required" ),
	STORE_ID_IS_REQUIRED( "Store is required" ),
	STORE_INFO_IS_REQUIRED( "Store info is required" ),
	CUSTOMER_ID_NOT_EXISTS("Customer ID does not exist");
