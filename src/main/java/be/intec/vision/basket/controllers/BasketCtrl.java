...
public class BasketCtrl {
    ...
    @Operation(summary = "Update session by the basket id")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Updated the session",
                    content = {@Content(mediaType = "application/json",
                            schema = @Schema(implementation = BasketResponse.class))}),
            @ApiResponse(responseCode = "400", description = "Session couldn't be updated",
                    content = @Content),
